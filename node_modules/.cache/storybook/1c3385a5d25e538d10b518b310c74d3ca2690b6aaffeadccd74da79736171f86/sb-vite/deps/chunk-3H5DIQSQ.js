...
var LazySyntaxHighlighter = (0, import_react16.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-BP7B2CQK-MGOPRBDS.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react16.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-BP7B2CQK-MGOPRBDS.js"), import("./formatter-2WMMO6ZP-LTB2HDVI.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
//# sourceMappingURL=chunk-3H5DIQSQ.js.map
